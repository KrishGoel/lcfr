...
<div class="w-10/12 mx-auto min-h-[calc(100vh-160px)] flex">
	...
	<div class="mt-8">
		<h3 class="font-semibold text-slate-400 text-lg">
			Welcome Back
		</h3>
		...
		<div class="grid grid-cols-2 xs:grid-cols-1 sm:grid-cols-1 md:grid-cols-1 gap-8">
			<div class="m-auto">
				...
				<a
					...
					class="inline-flex justify-center rounded-lg text-sm font-semibold py-3 px-5 bg-sky-600 text-white hover:bg-indigo-700 duration-300 cursor-pointer shadow-xl hover:shadow-none sm:py-2 sm:px-1.5 sm:text-xs"
				>
